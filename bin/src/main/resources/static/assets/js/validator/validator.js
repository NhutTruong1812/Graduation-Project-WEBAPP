...
Validator.isNumber(selector, message) {
    return {
        selector: selector,
        test: function(value) {
            return typeof value === "number" ? undefined : message || 'Trường này phải là số!';
        }
    };
}

Validator.isInteger(selector, message) {
    return {
        selector: selector,
        test: function(value) {
...
Validator.maxValue(selector, maxValue, message) {
    return {
        selector: selector,
        test: function(value) {
...
Validator.minValue(selector, minValue, message) {
    return {
        selector: selector,
        test: function(value) {
            return Number(value.trim()) >= minValue ? undefined : message || 'Vui lòng nhập giá trị tối thiểu là ' + minValue + '!';
        }
    };
}

Validator.isString(selector, message) {
    return {
        selector: selector,
        test: function(value) {
...
Validator.isNotContainsSymbol(selector, message) {
    return {
        selector: selector,
        test: function(value) {
            let regex = /[ `!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/;
...
Validator.isImageUrl(selector, message) {
    return {
        selector: selector,
        test: function(value) {
